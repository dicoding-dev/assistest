...
describe('checklist id resolver test', () => {
    ...
    it('should generate report properly', function () {
        ...
        expect(result.checklist.PROJECT_HAVE_CORRECT_RUNNER_SCRIPT.checklistId).toStrictEqual(43225)
        expect(result.checklist.PROJECT_HAVE_CORRECT_PORT.checklistId).toStrictEqual(43220)
        expect(result.checklist.API_CAN_INSERT_BOOK.checklistId).toStrictEqual(43195)
        expect(result.checklist.API_CAN_GET_ALL_BOOK.checklistId).toStrictEqual(43200)
        expect(result.checklist.API_CAN_GET_DETAIL_BOOK.checklistId).toStrictEqual(43205)
        expect(result.checklist.API_CAN_UPDATE_BOOK.checklistId).toStrictEqual(43210)
        expect(result.checklist.API_CAN_DELETE_BOOK.checklistId).toStrictEqual(43215)
        expect(result.checklist_completed).toEqual([43220, 43225, 43195, 43200, 43205, 43210, 43215])
